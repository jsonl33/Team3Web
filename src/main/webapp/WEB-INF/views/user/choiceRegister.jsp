        ...
        <div class="card-body">
          ...
          <div class="d-grid gap-2">
            ...
            <button class="btn btn-register" onclick="openNaver()">
              <img src="<%=request.getContextPath()%>/resources/img/icon/naverLogin_white.png" class="btn-icon" alt="네이버 로그인">
              	네이버로 가입하기
            </button>
            <button class="btn btn-register" onclick="openKakao()">
              <img src="<%=request.getContextPath()%>/resources/img/icon/kakao_login_medium_wide.png" class="btn-icon" alt="카카오 로그인">
              	카카오로 가입하기
            </button>
          </div>
        </div>
